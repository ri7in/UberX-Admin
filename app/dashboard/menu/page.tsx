...
export default function MenuPage() {
  ...
  const handleAddItem = () => {
    if (!newItem.name || !newItem.price || !newItem.preparationTime) {
      toast({
        title: "Error",
        description: "Name, price, and preparation time are required",
        variant: "destructive",
      })
      return
    }
    ...
    const prepTime = Number(newItem.preparationTime)
      ...
      <div className="flex items-center justify-between">
        ...
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          <DialogTrigger asChild>
            <Button className="bg-[#4ade80] hover:bg-[#22c55e] text-white transition-colors duration-200">
          ...
          <DialogContent>
            ...
            <DialogFooter>
              ...
              <Button onClick={handleAddItem} className="bg-[#4ade80] hover:bg-[#22c55e] text-white">
                Add Item
              </Button>
            </DialogFooter>
          </DialogContent>
                                    ...
                                    <div className="grid gap-2">
                                      ...
                                      <Input
                                        ...
                                        onChange={(e) =>
                                          setEditingItem({
                                            ...editingItem,
                                            preparationTime: Number.parseInt(e.target.value),
                                          })
                                        }
                                      />
                                    </div>
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            ...
                            <div className="flex items-center mt-1 text-[#4ade80]">
                              ...
                              <span className="text-xs">{item.preparationTime} mins prep time</span>
                            </div>
                          </div>
                        </div>
                      </CardContent>
